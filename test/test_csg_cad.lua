...
if cad.export(i, "output/intersection.stl") then
    print("Exported output/intersection.stl")
else
...
if cad.export(d, "output/difference.stl") then
    print("Exported output/difference.stl")
else
...
if cad.export(u, "output/union.stl") then
    print("Exported output/union.stl")
else
