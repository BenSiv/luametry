...
-- roof = cad.modify.translate( roof, {P.cabin_offset_x, 0, P.roof_height})
...
-- chimney = cad.combine.difference( {chimney_outer, chimney_inner})
...
benchy = cad.combine.union( {cabin})
