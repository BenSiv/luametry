...
export CC=g++
luam $LUAM_DIR/lib/static/static.lua entry.lua cad.lua shapes.lua stl.lua step.lua obj.lua threemf.lua font.lua cli.lua reparameterize.lua \
...
echo "Cleanup"
rm -f cad.lua shapes.lua stl.lua step.lua obj.lua threemf.lua font.lua cli.lua reparameterize.lua csg_manifold.a lfs.a entry.static.c
rm -rf lib/
